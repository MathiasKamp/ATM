...
namespace HæveAutomaten
{
    ...
    /// </summary>
    public class DatabaseManagerWithFile
    {
        ...
        public void WithdrawMoney(string name, string lastName, decimal amount)
        {
            ...
            File.WriteAllLines(AccountFile, str);
        }
        ...
        public static Account CreateAccount(string name, string lastName, decimal balance)
        {
        ...
        /// <param name="lastName"></param>
        /// <returns>Account</returns>
        public static Account GetSpecificAccount(string name, string lastName)
        {
            List<Account> accounts = GetAllAccounts();
            Account tmpAcc = null;
        ...
        public static List<Account> GetAllAccounts()
        {
            ...
            string[] content = File.ReadAllLines(AccountFile);
